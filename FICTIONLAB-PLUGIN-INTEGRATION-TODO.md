...
### Phase 1: Minimum Viable Integration (1-2 hours)
1. ✅ Add `handlePluginMenuAction()` to plugin-manager.ts
2. ✅ Send 'plugin-action' IPC message to renderer
3. ✅ Show simple alert in renderer when action received

### Phase 2: Basic View System (2-3 hours)
1. ✅ Add plugin view overlay to FictionLab renderer
2. ✅ Register `plugin://` protocol
3. ✅ Load plugin renderer in iframe

### Phase 3: Full Integration (3-4 hours)
1. ✅ Create PluginViewManager with BrowserView
2. ✅ Add view lifecycle management
3. ✅ Add plugin-to-FictionLab communication

### Phase 4: Polish (2-3 hours)
1. ✅ Add view transitions/animations
2. ✅ Add plugin view state persistence
3. ✅ Add keyboard shortcuts
4. ✅ Add plugin view tabs
