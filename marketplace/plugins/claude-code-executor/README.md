...
4. **Install database schema** (if not already installed):
   ```bash
   psql -U fictionlab_user -d fictionlab -f schema.sql
   ```

5. **Restart FictionLab** - the plugin will be automatically discovered and loaded
