...
import { SessionManager } from './SessionManager.postgres';
import { ClaudeCodeExecutor } from './ClaudeCodeExecutor';
import { OutputParser } from './OutputParser';
import { UsageTracker } from './UsageTracker.postgres';
import type { PluginDatabase } from '../database/PluginDatabase';
import type { PluginLogger } from '@fictionlab/plugin-api';
import type { WorkflowManagerClient } from '../../services/WorkflowManagerClient';
import {
  ExecutionJob,
  ExecutionQueue,
...
export class AgentOrchestrationService extends EventEmitter {
  ...
  private workflowClient: WorkflowManagerClient | null;
  ...
  constructor(config: AgentOrchestrationConfig) {
    ...
    this.queueManager = new QueueManager({ maxConcurrent: config.maxConcurrent });
    ...
    try {
      ...
      for (const jobRecord of pendingJobs) {
        ...
        const job: ExecutionJob = {
          ...
          status: jobRecord.status as ExecutionJob['status'],
