 ...
 */
export async function example2_SimpleCompletion() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
 ...
 */
export async function example3_ChatConversation() {
  const aiService = new AIService({
    openai: {
      apiKey: 'your-openai-api-key',
    },
 ...
 */
export async function example4_AdvancedRequest() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
 ...
 */
export async function example6_ProviderSwitching() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
  ...
  const claudeResponse = await aiService.complete(
    'What is AI?',
    'claude-3-5-sonnet-20241022'
  );
  ...
  const gptResponse = await aiService.complete(
    'What is AI?',
    'gpt-4-turbo-preview',
    'openai'
  );
 ...
 */
export async function example7_TokenTracking() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
 ...
 */
export async function example9_RateLimiting() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
      rateLimit: {
 ...
 */
export async function example10_PromptTemplating() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
 ...
 */
export async function example11_InteractionLogging() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
 ...
 */
export async function example12_RetryLogic() {
  const aiService = new AIService({
    anthropic: {
      apiKey: 'your-anthropic-api-key',
    },
